...
class MerchantUrls implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cancellation_terms'] = $data['cancellation_terms'] ?? null;
        $this->container['shipping_option_update'] = $data['shipping_option_update'] ?? null;
        $this->container['address_update'] = $data['address_update'] ?? null;
        $this->container['country_change'] = $data['country_change'] ?? null;
    }
