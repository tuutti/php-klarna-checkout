...
/**
 * AttachmentDisplayBodyItinerary1 Class Doc Comment
 *
 * @category Class
 * @package  Klarna\Checkout
 * @author   OpenAPI Generator team
 ...
 */
class AttachmentDisplayBodyItinerary1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'attachment_display_body_itinerary_1';
     ...
     * Sets departure
     *
     * @param string|null $departure City code or name
     *
     * @return self
     */
     ...
     * Sets arrival
     *
     * @param string|null $arrival City code or name
     *
     * @return self
     */
     ...
     * Sets carrier
     *
     * @param string|null $carrier Name of transportation company
     *
     * @return self
     */
     ...
     * Sets segment_price
     *
     * @param int|null $segment_price Local currency
     *
     * @return self
     */
