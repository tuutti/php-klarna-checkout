...
class Options implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        ...
        'auto_capture' => null,
        'require_client_validation' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'color_checkbox' => false,
        'color_checkbox_checkmark' => false,
        'color_header' => false,
        'color_link' => false,
    ...
    protected static $setters = [
        ...
        'require_client_validation' => 'setRequireClientValidation',
    ...
    protected static $getters = [
        ...
        'require_client_validation' => 'getRequireClientValidation',
    ...
    {
        $this->setIfExists('require_validate_callback_success', $data ?? [], null);
        $this->setIfExists('acquiring_channel', $data ?? [], null);
        $this->setIfExists('vat_removed', $data ?? [], null);
        $this->setIfExists('allow_separate_shipping_address', $data ?? [], null);
        $this->setIfExists('color_button', $data ?? [], null);
        $this->setIfExists('color_button_text', $data ?? [], null);
        $this->setIfExists('color_checkbox', $data ?? [], null);
        $this->setIfExists('color_checkbox_checkmark', $data ?? [], null);
        $this->setIfExists('color_header', $data ?? [], null);
        $this->setIfExists('color_link', $data ?? [], null);
        $this->setIfExists('date_of_birth_mandatory', $data ?? [], null);
        $this->setIfExists('shipping_details', $data ?? [], null);
        $this->setIfExists('title_mandatory', $data ?? [], null);
        $this->setIfExists('additional_checkbox', $data ?? [], null);
        $this->setIfExists('national_identification_number_mandatory', $data ?? [], null);
        $this->setIfExists('additional_merchant_terms', $data ?? [], null);
        $this->setIfExists('phone_mandatory', $data ?? [], null);
        $this->setIfExists('radius_border', $data ?? [], null);
        $this->setIfExists('allowed_customer_types', $data ?? [], null);
        $this->setIfExists('show_subtotal_detail', $data ?? [], null);
        $this->setIfExists('additional_checkboxes', $data ?? [], null);
        $this->setIfExists('verify_national_identification_number', $data ?? [], null);
        $this->setIfExists('auto_capture', $data ?? [], null);
        $this->setIfExists('require_client_validation', $data ?? [], null);
        $this->setIfExists('enable_discount_module', $data ?? [], null);
        $this->setIfExists('show_vat_registration_number_field', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($require_validate_callback_success)) {
            throw new \InvalidArgumentException('non-nullable require_validate_callback_success cannot be null');
        }
     ...
     *
     * @param string|null $acquiring_channel Acquiring channel for the order. The possible values are: <ul><li><em>ECOMMERCE for \"E-commerce\"</em></li><li><em>IN_STORE for \"Purchase in boutique\"</em></li><li><em>Default : ECOMMERCE</em></li></ul>
     *
     * @return self
     */
    public function setAcquiringChannel($acquiring_channel)
    {
        ...
        if ((!preg_match("/ECOMMERCE|MOTO|IN_STORE|TELESALES/", ObjectSerializer::toString($acquiring_channel)))) {
    ...
    {
        if (is_null($vat_removed)) {
            throw new \InvalidArgumentException('non-nullable vat_removed cannot be null');
        }
    ...
    {
        if (is_null($allow_separate_shipping_address)) {
            throw new \InvalidArgumentException('non-nullable allow_separate_shipping_address cannot be null');
        }
    ...
    {
        if (is_null($color_button)) {
            throw new \InvalidArgumentException('non-nullable color_button cannot be null');
        }

        if ((!preg_match("/^#[A-Fa-f0-9]{6}$/", ObjectSerializer::toString($color_button)))) {
    ...
    {
        if (is_null($color_button_text)) {
            throw new \InvalidArgumentException('non-nullable color_button_text cannot be null');
        }

        if ((!preg_match("/^#[A-Fa-f0-9]{6}$/", ObjectSerializer::toString($color_button_text)))) {
    ...
    {
        if (is_null($color_checkbox)) {
            throw new \InvalidArgumentException('non-nullable color_checkbox cannot be null');
        }

        if ((!preg_match("/^#[A-Fa-f0-9]{6}$/", ObjectSerializer::toString($color_checkbox)))) {
    ...
    {
        if (is_null($color_checkbox_checkmark)) {
            throw new \InvalidArgumentException('non-nullable color_checkbox_checkmark cannot be null');
        }

        if ((!preg_match("/^#[A-Fa-f0-9]{6}$/", ObjectSerializer::toString($color_checkbox_checkmark)))) {
    ...
    {
        if (is_null($color_header)) {
            throw new \InvalidArgumentException('non-nullable color_header cannot be null');
        }

        if ((!preg_match("/^#[A-Fa-f0-9]{6}$/", ObjectSerializer::toString($color_header)))) {
    ...
    {
        if (is_null($color_link)) {
            throw new \InvalidArgumentException('non-nullable color_link cannot be null');
        }

        if ((!preg_match("/^#[A-Fa-f0-9]{6}$/", ObjectSerializer::toString($color_link)))) {
    ...
    {
        if (is_null($date_of_birth_mandatory)) {
            throw new \InvalidArgumentException('non-nullable date_of_birth_mandatory cannot be null');
        }
    ...
    {
        if (is_null($title_mandatory)) {
            throw new \InvalidArgumentException('non-nullable title_mandatory cannot be null');
        }
    ...
    {
        if (is_null($additional_checkbox)) {
            throw new \InvalidArgumentException('non-nullable additional_checkbox cannot be null');
        }
    ...
    {
        if (is_null($national_identification_number_mandatory)) {
            throw new \InvalidArgumentException('non-nullable national_identification_number_mandatory cannot be null');
        }
    ...
    {
        if (is_null($additional_merchant_terms)) {
            throw new \InvalidArgumentException('non-nullable additional_merchant_terms cannot be null');
        }
    ...
    {
        if (is_null($phone_mandatory)) {
            throw new \InvalidArgumentException('non-nullable phone_mandatory cannot be null');
        }
    ...
    {
        if (is_null($allowed_customer_types)) {
            throw new \InvalidArgumentException('non-nullable allowed_customer_types cannot be null');
        }

        if ((count($allowed_customer_types) > 2)) {
        ...
        if ((count($allowed_customer_types) < 1)) {
    ...
    {
        if (is_null($show_subtotal_detail)) {
            throw new \InvalidArgumentException('non-nullable show_subtotal_detail cannot be null');
        }
    ...
    {
        if (is_null($additional_checkboxes)) {
            throw new \InvalidArgumentException('non-nullable additional_checkboxes cannot be null');
        }
    ...
    {
        if (is_null($verify_national_identification_number)) {
            throw new \InvalidArgumentException('non-nullable verify_national_identification_number cannot be null');
        }
    ...
    /**
     * Gets require_client_validation
     *
     * @return bool|null
     */
    public function getRequireClientValidation()
    {
        return $this->container['require_client_validation'];
    }

    /**
     * Sets require_client_validation
     *
     * @param bool|null $require_client_validation If true, a client side validation is needed to complete the purchase
     *
     * @return self
     */
    public function setRequireClientValidation($require_client_validation)
    {
        if (is_null($require_client_validation)) {
            throw new \InvalidArgumentException('non-nullable require_client_validation cannot be null');
        }
        $this->container['require_client_validation'] = $require_client_validation;
    ...
    {
        if (is_null($enable_discount_module)) {
            throw new \InvalidArgumentException('non-nullable enable_discount_module cannot be null');
        }
    ...
    {
        if (is_null($show_vat_registration_number_field)) {
            throw new \InvalidArgumentException('non-nullable show_vat_registration_number_field cannot be null');
        }
